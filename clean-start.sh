#!/usr/bin/env bash
# clean-start.sh — free eBay emulator ports and boot a fresh emulator suite.
#
# Kills only the six eBay-specific ports (source: firebase.json emulators block).
...
#
# Run from anywhere:  bash games/ebay/clean-start.sh
# Or from ebay/:     ./clean-start.sh
# Press Ctrl+C to stop everything.  Log: /tmp/ebay-emulators.log
...
EBAY_PORTS=($PORT_AUTH $PORT_FUNCTIONS $PORT_FIRESTORE $PORT_DATABASE $PORT_HOSTING $PORT_UI)

LOG=/tmp/ebay-emulators.log

# ── 0. Free eBay emulator ports ──────────────────────────────────────────────
echo "▶ Clearing eBay emulator ports..."
KILLED_ANY=false
for port in "${EBAY_PORTS[@]}"; do
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  eBay emulators are up ✅"
echo "  Functions: http://localhost:${PORT_FUNCTIONS}/ebay-mygames-live/us-central1"
echo "  Firestore: http://localhost:${PORT_FIRESTORE}"
echo "  Database:  http://localhost:${PORT_DATABASE}"
echo "  Log:       $LOG"
