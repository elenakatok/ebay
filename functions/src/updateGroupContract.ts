 ...
 */
export const updateGroupContract = onCall({ cors: ebayGameDef.corsOrigins }, async (request) => {
  ...
  if (agreement_reached) {
    ...
    const check = validateOutcome(ebayGameDef.outcomeSchema, provided as Outcome)
    if (!check.valid) {
